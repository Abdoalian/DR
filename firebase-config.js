...
window.RwaqDB = {
  ...
  async getNews() {
    ...
    return local ? JSON.parse(local) : [
      { id: 'n-1', title: 'انطلاق فعاليات يوم عرض المشروعات Demo Day للدفعة الجديدة', date: '2026-08-26', summary: 'استعرضت 12 شركة ناشئة محتضنة حلولها التكنولوجية أمام عدد من كبار المستثمرين وصناديق الاستثمار الجريء.', image: 'event.png' },
      { id: 'n-2', title: 'تطوير وتحديث معامل التصنيع السريع والميكروسكوبات الرقمية', date: '2026-08-18', summary: 'توفير معدات نمذجة جديدة ثلاثية الأبعاد لدعم المشروعات الهندسية والطبية بجامعة الأزهر.', image: 'tech_lab.png' },
      { id: 'n-3', title: 'ورشة عمل مكثفة حول دراسات الجدوى والنمو المالي', date: '2026-08-10', summary: 'جلسة تفاعلية بحضور خبراء الادارة المالية لتدريب الفرق على التوقعات المالية ومؤشرات الأداء الرئيسية KPIs.', image: 'coworking.png' }
    ];
  },
